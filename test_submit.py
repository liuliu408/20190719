...
if __name__ == "__main__":
    import time
    src_path = "/home/liuq/wind/agriculture/origin_data/test_data"
    dst_path = "/home/liuq/wind/agriculture/231717_LQ2/model_train/predict_{}/".format(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()))
